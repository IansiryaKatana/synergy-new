...
('service-2','Compliance Department','Compliance Department','Ensuring Market Readiness & Regulatory Confidence','Ensuring Market Readiness & Regulatory Confidence',null,$$[
  {"title":"Regulatory Strategy & Market Entry","description":"We define clear regulatory pathways for products and expansion by assessing approval requirements, risks, and timelines. This ensures efficient entry into markets while minimizing delays and maintaining full compliance with regional standards."},
  {"title":"Submissions & Authority Management","description":"We handle all regulatory submissions, approvals, renewals, and communications with governing bodies. Documentation is maintained accurately, ensuring products remain authorized and aligned with all applicable regulatory requirements."},
...
('service-3','Human Resources','Human Resources','Building & Managing High-Performance Teams','Building & Managing High-Performance Teams',null,$$[
  {"title":"Talent Acquisition & Workforce Planning","description":"We attract and recruit top talent across UAE and UK markets through structured hiring, compliant contracts, and effective onboarding. Workforce planning ensures the organization scales efficiently with the right people in place."},
  ...
  {"title":"Payroll, Benefits & Legal Compliance","description":"We administer salaries, benefits, and compensation structures aligned with UAE and UK regulations. All payroll processes are accurate and compliant, ensuring employees are paid fairly while minimizing legal and financial risk."},
  {"title":"Performance, Engagement & Development","description":"We drive employee performance through structured appraisals, training programs, and engagement initiatives. This builds a motivated, skilled workforce aligned with company goals and fosters a strong, consistent organizational culture."}
]$$::jsonb,3,true),
('service-4','Project Management','Project Management','Delivering Projects with Precision & Control','Delivering Projects with Precision & Control',null,$$[
  {"title":"Project Planning & Strategy","description":"We define clear project scopes, timelines, and resource plans aligned with business objectives. This ensures every project begins with structured direction, minimizing risks and setting a strong foundation for successful delivery."},
  ...
  {"title":"Monitoring & Performance Control","description":"We track progress through milestones, KPIs, and reporting frameworks. Issues are identified early, adjustments are made proactively, and performance is continuously optimized to keep projects on schedule and within scope."},
